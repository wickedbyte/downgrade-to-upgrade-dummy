...
* GitHub Issues: <https://github.com/wickedbyte/downgrade-to-upgrade-dummy/issues>
...
* wickedbyte/downgrade-to-upgrade-dummy follows a superset of **[PSR-12 coding standard][psr-12]**.
  Please ensure your code does, too. _Hint: run `composer dev:lint` to check._
* Please **write tests** for any new features you add.
* Please **ensure that tests pass** before submitting your pull request.
  wickedbyte/downgrade-to-upgrade-dummy automatically runs tests for pull requests. However,
...
[github]: https://github.com/wickedbyte/downgrade-to-upgrade-dummy
[issues]: https://github.com/wickedbyte/downgrade-to-upgrade-dummy/issues
[pull requests]: https://github.com/wickedbyte/downgrade-to-upgrade-dummy/pulls
